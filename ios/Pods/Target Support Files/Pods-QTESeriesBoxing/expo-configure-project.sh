...
with_node \
  ...
  --target "/Users/jasonday/repos/QTE_Series_Boxing/ios/Pods/Target Support Files/Pods-QTESeriesBoxing/ExpoModulesProvider.swift" \
  --entitlement "/Users/jasonday/repos/QTE_Series_Boxing/ios/QTESeriesBoxing/QTESeriesBoxing.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-av" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linear-gradient" "expo-splash-screen"
